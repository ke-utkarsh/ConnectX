...
public final class ActivityModule_ProvideScanQRCodeViewModelFactory
    implements Factory<ScanQRCodeViewModel> {
  ...
  public ActivityModule_ProvideScanQRCodeViewModelFactory(
  ...
  public ScanQRCodeViewModel get() {
    return proxyProvideScanQRCodeViewModel(
        module,
  ...
  public static ActivityModule_ProvideScanQRCodeViewModelFactory create(
      ActivityModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new ActivityModule_ProvideScanQRCodeViewModelFactory(
        module,
        schedulerProvider,
  ...
  public static ScanQRCodeViewModel proxyProvideScanQRCodeViewModel(
    ...
    return Preconditions.checkNotNull(
        instance.provideScanQRCodeViewModel(
