...
public final class FragmentModule_ProvideNewHomeViewModelFactory implements Factory<HomeViewModel> {
  ...
  public FragmentModule_ProvideNewHomeViewModelFactory(
  ...
  public HomeViewModel get() {
    return proxyProvideNewHomeViewModel(
        module,
  ...
  public static FragmentModule_ProvideNewHomeViewModelFactory create(
      FragmentModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new FragmentModule_ProvideNewHomeViewModelFactory(
        module,
        schedulerProvider,
  ...
  public static HomeViewModel proxyProvideNewHomeViewModel(
    ...
    return Preconditions.checkNotNull(
        instance.provideNewHomeViewModel(
