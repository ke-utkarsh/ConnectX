...
public final class ActivityModule_ProvideForgotPasswordViewModelFactory
  ...
  public ActivityModule_ProvideForgotPasswordViewModelFactory(
  ...
  public ForgotPasswordViewModel get() {
    return proxyProvideForgotPasswordViewModel(
        module,
  ...
  public static ActivityModule_ProvideForgotPasswordViewModelFactory create(
      ActivityModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new ActivityModule_ProvideForgotPasswordViewModelFactory(
        module,
        schedulerProvider,
  ...
  public static ForgotPasswordViewModel proxyProvideForgotPasswordViewModel(
    ...
    return Preconditions.checkNotNull(
        instance.provideForgotPasswordViewModel(
