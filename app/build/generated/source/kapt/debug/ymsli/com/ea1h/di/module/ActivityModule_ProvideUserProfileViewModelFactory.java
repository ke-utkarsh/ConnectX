...
public final class ActivityModule_ProvideUserProfileViewModelFactory
    implements Factory<UserProfileViewModel> {
  ...
  public ActivityModule_ProvideUserProfileViewModelFactory(
  ...
  public UserProfileViewModel get() {
    return proxyProvideUserProfileViewModel(
        module,
  ...
  public static ActivityModule_ProvideUserProfileViewModelFactory create(
      ActivityModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new ActivityModule_ProvideUserProfileViewModelFactory(
        module,
        schedulerProvider,
  ...
  public static UserProfileViewModel proxyProvideUserProfileViewModel(
    ...
    return Preconditions.checkNotNull(
        instance.provideUserProfileViewModel(
