...
public final class FragmentModule_ProvidePrivacyPolicyViewModelFactory
  ...
  public FragmentModule_ProvidePrivacyPolicyViewModelFactory(
  ...
  public PrivacyPolicyViewModel get() {
    return proxyProvidePrivacyPolicyViewModel(
        module,
  ...
  public static FragmentModule_ProvidePrivacyPolicyViewModelFactory create(
      FragmentModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new FragmentModule_ProvidePrivacyPolicyViewModelFactory(
        module,
        schedulerProvider,
  ...
  public static PrivacyPolicyViewModel proxyProvidePrivacyPolicyViewModel(
    ...
    return Preconditions.checkNotNull(
        instance.providePrivacyPolicyViewModel(
