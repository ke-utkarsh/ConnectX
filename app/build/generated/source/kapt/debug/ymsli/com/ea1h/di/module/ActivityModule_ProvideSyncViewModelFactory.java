...
public final class ActivityModule_ProvideSyncViewModelFactory implements Factory<SyncViewModel> {
  ...
  public ActivityModule_ProvideSyncViewModelFactory(
  ...
  public SyncViewModel get() {
    return proxyProvideSyncViewModel(
        module,
  ...
  public static ActivityModule_ProvideSyncViewModelFactory create(
      ActivityModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new ActivityModule_ProvideSyncViewModelFactory(
        module,
        schedulerProvider,
  ...
  public static SyncViewModel proxyProvideSyncViewModel(
