...
public final class FragmentModule_ProvideUnregisterUserViewModelFactory
    implements Factory<UnregisterUserViewModel> {
  ...
  public FragmentModule_ProvideUnregisterUserViewModelFactory(
  ...
  @Override
  public UnregisterUserViewModel get() {
    return proxyProvideUnregisterUserViewModel(
        module,
  ...
  public static FragmentModule_ProvideUnregisterUserViewModelFactory create(
      FragmentModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new FragmentModule_ProvideUnregisterUserViewModelFactory(
        module,
        schedulerProvider,
  ...
  public static UnregisterUserViewModel proxyProvideUnregisterUserViewModel(
    ...
    return Preconditions.checkNotNull(
        instance.provideUnregisterUserViewModel(
