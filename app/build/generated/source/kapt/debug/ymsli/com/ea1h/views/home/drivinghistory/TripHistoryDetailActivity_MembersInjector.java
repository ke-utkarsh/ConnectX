...
public final class TripHistoryDetailActivity_MembersInjector
    implements MembersInjector<TripHistoryDetailActivity> {
  private final Provider<TripHistoryDetailViewModel> viewModelProvider;
  ...
  public TripHistoryDetailActivity_MembersInjector(
      Provider<TripHistoryDetailViewModel> viewModelProvider,
  ...
  public static MembersInjector<TripHistoryDetailActivity> create(
      Provider<TripHistoryDetailViewModel> viewModelProvider,
      Provider<Gigya<GigyaResponse>> gigyaProvider,
      Provider<LocationManager> locationManagerProvider,
      Provider<ErrorAckFragment> userAckFragmentProvider,
      Provider<ProgressFragment> progressFragmentProvider,
      Provider<MFECUProgressFragment> mfecuProgressFragmentProvider) {
    return new TripHistoryDetailActivity_MembersInjector(
        viewModelProvider,
        gigyaProvider,
  ...
  @Override
  public void injectMembers(TripHistoryDetailActivity instance) {
