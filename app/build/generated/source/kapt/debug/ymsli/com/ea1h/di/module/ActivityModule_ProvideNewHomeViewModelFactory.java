...
public final class ActivityModule_ProvideNewHomeViewModelFactory implements Factory<HomeViewModel> {
  ...
  public ActivityModule_ProvideNewHomeViewModelFactory(
  ...
  public static ActivityModule_ProvideNewHomeViewModelFactory create(
      ActivityModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new ActivityModule_ProvideNewHomeViewModelFactory(
        module,
        schedulerProvider,
