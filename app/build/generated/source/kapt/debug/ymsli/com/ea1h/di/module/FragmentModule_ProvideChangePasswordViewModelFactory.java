...
public final class FragmentModule_ProvideChangePasswordViewModelFactory
    implements Factory<ChangePasswordViewModel> {
  ...
  public FragmentModule_ProvideChangePasswordViewModelFactory(
  ...
  public ChangePasswordViewModel get() {
    return proxyProvideChangePasswordViewModel(
        module,
  ...
  public static FragmentModule_ProvideChangePasswordViewModelFactory create(
      FragmentModule module,
      Provider<SchedulerProvider> schedulerProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<NetworkHelper> networkHelperProvider,
      Provider<EA1HRepository> ea1hRepositoryProvider) {
    return new FragmentModule_ProvideChangePasswordViewModelFactory(
        module,
        schedulerProvider,
  ...
  public static ChangePasswordViewModel proxyProvideChangePasswordViewModel(
    ...
    return Preconditions.checkNotNull(
        instance.provideChangePasswordViewModel(
