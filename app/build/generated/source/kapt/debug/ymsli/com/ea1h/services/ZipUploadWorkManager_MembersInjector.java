...
public final class ZipUploadWorkManager_MembersInjector
    implements MembersInjector<ZipUploadWorkManager> {
  ...
  public ZipUploadWorkManager_MembersInjector(
  ...
  public static MembersInjector<ZipUploadWorkManager> create(
      Provider<EA1HRepository> eA1HRepositoryProvider,
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<SchedulerProvider> schedulerProvider) {
    return new ZipUploadWorkManager_MembersInjector(
        eA1HRepositoryProvider, compositeDisposableProvider, schedulerProvider);
  }

  @Override
  public void injectMembers(ZipUploadWorkManager instance) {
