...
class AppVersionControllerApi(basePath: kotlin.String = "http://iymconnected-api-dev.ap-south-1.elasticbeanstalk.com/") : ApiClient(basePath) {
    ...
    fun getAppStatusUsingPOST(body: AppVersionRequestDTO, authorization: kotlin.String): ResponseBody {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
                "/app/version", headers = localVariableHeaders
        )
