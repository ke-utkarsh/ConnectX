...
class DeviceControllerApi(basePath: kotlin.String = "http://iymconnected-api-dev.ap-south-1.elasticbeanstalk.com/") : ApiClient(basePath) {
    ...
    fun updateFCMTokenUsingPOST(body: DeviceUpdateRequestModel, authorization: kotlin.String): ResponseBody {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
                "/device/updateFCMToken", headers = localVariableHeaders
        )
